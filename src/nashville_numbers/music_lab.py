...
GROOVE_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "pulse": {
        ...
        "chord_pattern": [
            {"beat": 0.0, "velocity_scale": 1.0},
            {"beat": 1.0, "velocity_scale": 0.65},
            {"beat": 2.0, "velocity_scale": 0.85},
            {"beat": 3.0, "velocity_scale": 0.6},
        ],
        "bass_hits": [
            {"beat": 0.0, "velocity": 86, "octave_offset": 0},
        ],
    ...
    "waltz": {
        ...
        "chord_pattern": [
            {"beat": 0.0, "velocity_scale": 1.0},
            {"beat": 1.0, "velocity_scale": 0.6},
            {"beat": 2.0, "velocity_scale": 0.65},
        ],
        "bass_hits": [
            {"beat": 0.0, "velocity": 86, "octave_offset": 0},
        ],
    ...
    "shuffle": {
        ...
        "chord_pattern": [
            {"beat": 0.0, "velocity_scale": 1.0},
            {"beat": 1.0, "velocity_scale": 0.7},
            {"beat": 2.0, "velocity_scale": 0.9},
            {"beat": 3.0, "velocity_scale": 0.65},
        ],
        "bass_hits": [
            {"beat": 0.0, "velocity": 86, "octave_offset": 0},
            {"beat_fraction": 0.5, "velocity": 78, "octave_offset": 1, "min_slot_beats": 2},
    ...
    "funk": {
        ...
        "chord_pattern": [
            {"beat": 0.0, "velocity_scale": 1.0},
            {"beat": 0.5, "velocity_scale": 0.6},
            {"beat": 1.5, "velocity_scale": 0.75},
            {"beat": 2.5, "velocity_scale": 0.55},
            {"beat": 3.0, "velocity_scale": 0.85},
        ],
        "bass_hits": [
            {"beat": 0.0, "velocity": 90, "octave_offset": 0},
            {"beat_fraction": 0.375, "velocity": 76, "octave_offset": 0, "min_slot_beats": 2},
        ],
        "chord_program": 0,
        "bass_program": 33,
        "swing": 0.15,
    ...
    "reggae": {
        ...
        "bass_pattern": "slot-roots",
        "chord_pattern": [
            {"beat": 0.5, "velocity_scale": 0.85},
            {"beat": 1.5, "velocity_scale": 0.9},
            {"beat": 2.5, "velocity_scale": 0.85},
            {"beat": 3.5, "velocity_scale": 0.9},
        ],
        "bass_hits": [
            {"beat": 0.0, "velocity": 88, "octave_offset": 0},
            {"beat_fraction": 0.5, "velocity": 78, "octave_offset": 0, "min_slot_beats": 2},
        ],
        "chord_program": 0,
        "bass_program": 33,
        "swing": 0.0,
    ...
    "ballad": {
        ...
        "chord_pattern": [{"beat": 0.0, "velocity_scale": 1.0}],
        "bass_hits": [
            {"beat": 0.0, "velocity": 80, "octave_offset": 0, "bar_downbeat_only": True},
        ],
        "chord_program": 46,
        "bass_program": 33,
        "swing": 0.0,
